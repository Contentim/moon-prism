<?php get_header();
  ...
  $link_price_list_spectechnika = get_field('link_price_list_spectechnika', $queried_object);
  $title_price_list_spectechnika = get_field('title_price_list_spectechnika', $queried_object);
    ...
    <div class="container">
     <?php
      ...
      <div class="col-xs-12 col-sm-4 col-md-3 sidebar-category-menu">
          ...
          <div class="item-spc">
            <div class="wrap_price_list item-spc-description">
              <div class="title_price_list">
                <?php echo $title_price_list_spectechnika; ?>
              </div>
            </div><a class="price_list_spectechnika caption-spc-btn" href="<?php echo $link_price_list_spectechnika; ?>">Посмотреть цены</a>
          </div>
          ...
          <div class="item-spc">
            <div class="item-spc-description">
              <img src="/content/themes/moon-prism/img/glossary-icon.png">
              <h3>Словарь терминов - глоссарий</h3>
              <p>Не понимаете какой-либо термин? Воспользуйтесь справочником.</p>
            </div><a class="caption-spc-btn" href="/info/slovar-terminov-po-avtokranam/" target="_blank">Перейти в словарь</a>
          </div>

          <div class="item-spc">
            <div class="item-spc-description">
              <img src="/content/uploads/2016/04/mos_obl.png">
              <h3>Города Московской области</h3>
              <p>Предоставим автокран для жителей и предприятий Подмосковья.</p>
            </div><a class="caption-spc-btn" href="/service/arenda-avtokrana-podmoskovie/">Перейти к списку</a>
          </div>
