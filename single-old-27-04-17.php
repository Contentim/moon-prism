    ...
    <div class="container">
      <div class="row mobile-reverse">
        ...
        <div class="row">
          ...
          <div class="related-machinery hide">
            <?php
            $curr_cats = get_the_category();
            $the_query = new WP_Query(array(
                'post_type'=>'post',
                'showposts' => 3,
                'orderby' => 'rand',
                'cat' => $curr_cats[0]->term_id,
                'post__not_in' => array(get_the_ID())
            ));
            if ($the_query->have_posts()) { ?>
              <div class="related-posts">
                <div class="related-post-title">Смотрите также</div>
                  <div class="row related-list">
                  <?php while ($the_query->have_posts()) : $the_query->the_post();?>
                    <div class="col-xs-4">
                      <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>" class="related-content">
                        <div class="rl-thumb">
                          <?php
                            $post_images = get_post_meta(get_the_ID(), 'inpost_gallery_data', true);
                            if ($post_images && !is_numeric($post_images)) {
                        ...
                        <span class="rl-title" ><?php the_title(); ?></span>
                      </a>
                    </div>
                  <?php endwhile; ?>
                </ul>
